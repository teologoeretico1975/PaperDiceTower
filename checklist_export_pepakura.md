...
- **Deflettori**: quattro strisce corrugate, ognuna un rettangolo con pieghe parallele al lato lungo. Le pieghe vanno **parallele alla luce**, cioè al lato che va da parete a parete: piegate nell'altro senso si ottiene un soffietto invece di una trave. Le linguette stanno sui due lati corti e si incollano a pareti opposte, quindi vanno inserite **prima di chiudere l'ultima cucitura del fusto**, partendo dalla più bassa. Alcune linguette coprono dall'interno un tratto di feritoia: è voluto, evitarlo avrebbe costretto ad ammassare le strisce su due sole quote.
