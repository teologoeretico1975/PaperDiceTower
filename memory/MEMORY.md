...
- [Policy memoria su disco](reference_memoria_su_disco.md) — le memorie di questo progetto vanno salvate qui (Cowork), non nella memoria locale di Claude
- [Panoramica progetto](project_panoramica.md) — cos'è il modello, come si rigenera dallo script, correzioni chieste dall'utente da non reintrodurre
